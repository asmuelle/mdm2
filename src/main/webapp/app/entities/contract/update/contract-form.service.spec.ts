      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            customerContactName: expect.any(Object),
            customerContactAddresslines: expect.any(Object),
            customerPurchaseNumber: expect.any(Object),
            kwiqlyOrderNumber: expect.any(Object),
            basePricePerMonth: expect.any(Object),
