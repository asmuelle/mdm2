...
public class CountryServiceImpl implements CountryService {
    ...
    /**
     *  Get all the countries where Address is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<Country> findAllWhereAddressIsNull() {
        log.debug("Request to get all countries where Address is null");
        return StreamSupport
            .stream(countryRepository.findAll().spliterator(), false)
            .filter(country -> country.getAddress() == null)
            .toList();
    }
