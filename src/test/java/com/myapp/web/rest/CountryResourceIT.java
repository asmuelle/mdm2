...
class CountryResourceIT {
    ...
    private static final String DEFAULT_ISOCODE = "AAAAAAAAAA";
    private static final String UPDATED_ISOCODE = "BBBBBBBBBB";
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).isocode(DEFAULT_ISOCODE);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).isocode(UPDATED_ISOCODE);
        return country;
    }
    ...
    void createCountry() throws Exception {
        ...
        assertThat(testCountry.getIsocode()).isEqualTo(DEFAULT_ISOCODE);
    }
    ...
    void getAllCountries() throws Exception {
        ...
        restCountryMockMvc
            ...
            .andExpect(jsonPath("$.[*].isocode").value(hasItem(DEFAULT_ISOCODE)));
    }
    ...
    void getCountry() throws Exception {
        ...
        restCountryMockMvc
            ...
            .andExpect(jsonPath("$.isocode").value(DEFAULT_ISOCODE));
    }
    ...
    void putExistingCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).isocode(UPDATED_ISOCODE);
        ...
        assertThat(testCountry.getIsocode()).isEqualTo(UPDATED_ISOCODE);
    }
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.name(UPDATED_NAME).isocode(UPDATED_ISOCODE);
