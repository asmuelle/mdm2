...
class AddressResourceIT {
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getAddresslines()).isEqualTo(DEFAULT_ADDRESSLINES);
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.city(UPDATED_CITY).postcode(UPDATED_POSTCODE).addresslines(UPDATED_ADDRESSLINES).lat(UPDATED_LAT).lon(UPDATED_LON);
        ...
        assertThat(testAddress.getAddresslines()).isEqualTo(UPDATED_ADDRESSLINES);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.city(UPDATED_CITY).postcode(UPDATED_POSTCODE).lat(UPDATED_LAT).lon(UPDATED_LON);
